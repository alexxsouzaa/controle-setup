...
function FieldLegend({
  ...
  variant = "legend",
  ...props
}: React.ComponentPropsWithoutRef<"legend"> & { variant?: "label" | "legend" }) {
  return (
    <legend
...
function Field({
  ...
  orientation = "vertical",
  ...props
}: React.ComponentPropsWithoutRef<"div"> & { orientation?: "vertical" | "horizontal" | "responsive" }) {
  return (
    <div
      role="group"
      data-slot="field"
...
function FieldError({
  ...
  errors,
  ...props
}: React.ComponentPropsWithoutRef<"div"> & { errors?: Array<{ message?: string }> }) {
