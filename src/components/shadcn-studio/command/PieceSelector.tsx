...
export function PieceSelector({ open, onOpenChange, pieces, selectedId, onSelect }: PieceSelectorProps) {
                  ...
                  >
                    {piece.image ? (
                      <img
                        src={piece.image}
                        alt={piece.name}
                        className="w-9 h-9 rounded-[4px] object-cover border shrink-0"
                      />
                    ) : (
                      <div className="w-9 h-9 rounded-[4px] bg-[var(--bg-secondary)] border flex items-center justify-center text-[var(--fg-muted)] shrink-0">
                    ...
                    <div className="ml-auto shrink-0" data-slot="command-shortcut">
                      <Button size="sm" variant={isSelected ? 'ghost' : 'default'} disabled={isSelected}>
